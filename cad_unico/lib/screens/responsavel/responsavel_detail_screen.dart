...
class _ResponsavelDetailScreenState extends State<ResponsavelDetailScreen> {
  ...
  Widget _buildContent(Responsavel responsavel) => SingleChildScrollView(
          ...
          children: [
            ...
            _buildInfoCard(
              ...
              children: [
                ...
                if (responsavel.complemento != null &&
                    responsavel.complemento!.isNotEmpty)
  ...
  Widget _buildStatusCard(Responsavel responsavel) => Card(
                  ...
                  children: [
                    Text(
                      ...
                      style: Theme.of(context).textTheme.titleMedium?.copyWith(
                            fontWeight: FontWeight.bold,
                            color:
                                responsavel.isAtivo ? Colors.green : Colors.red,
                          ),
                    ),
                    Text(
                      responsavel.isAtivo
  ...
  Widget _buildActionButtons(Responsavel responsavel) => Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          ElevatedButton.icon(
            onPressed: () =>
                context.go('/responsaveis/${responsavel.cpf}/editar'),
            icon: const Icon(Icons.edit),
  ...
  void _showShareDialog(Responsavel responsavel) {
    showDialog(
      context: context,
